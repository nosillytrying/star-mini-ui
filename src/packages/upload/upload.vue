...
export default {
  ...
  methods: {
    ...
    handleStart (rawFile) {
        // 给文件生成一个唯一的标识
        rawFile.uid = Math.random().toString(36).substr(2, 9) + this.tempIndex++
        let file = {
            status: 'ready', // 默认准备上传
    ...
    handleProgress (ev, rawFile) {
        ...
        file.percentage = file.percent || 0; // 赋值当前进度
