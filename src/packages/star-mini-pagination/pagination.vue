<template>
  <ul class="star-mini-pagination">
    <li>
      <star-mini-icon icon="left" @click="select(currentPage-1)"></star-mini-icon>
    </li>
    <li>
    ...
    <li>
      <star-mini-icon icon="right" @click="select(currentPage+1)"></star-mini-icon>
    </li>
  </ul>
</template>
